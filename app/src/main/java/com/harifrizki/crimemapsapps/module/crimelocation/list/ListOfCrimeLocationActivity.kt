...
import com.harifrizki.crimemapsapps.adapter.CrimeLocationAdapter
import com.harifrizki.crimemapsapps.databinding.ActivityListOfCrimeLocationBinding
import com.harifrizki.crimemapsapps.module.crimelocation.detail.DetailCrimeLocationActivity
...
class ListOfCrimeLocationActivity : BaseActivity() {
    ...
    private val viewModel by viewModel<ListOfCrimeLocationViewModel>()
