...
import com.harifrizki.crimemapsapps.adapter.AreaAdapter
import com.harifrizki.crimemapsapps.databinding.ActivityListOfAreaBinding
import com.harifrizki.crimemapsapps.module.area.form.FormAreaActivity
...
class ListOfAreaActivity : BaseActivity() {
    ...
    private val viewModel by viewModel<ListOfAreaViewModel>()
